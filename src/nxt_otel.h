...
extern void     nxt_otel_rs_send_trace(void *);
extern void   * nxt_otel_rs_get_or_create_trace(u_char *);
extern void     nxt_otel_rs_init(void (*)(u_char*), const char *, const char *, double);
extern void     nxt_otel_rs_copy_traceparent(u_char *, void *);
extern void     nxt_otel_rs_add_event_to_trace(void *, u_char *, u_char *);
