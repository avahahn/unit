...
pub struct AppsApiClient<C: hyper::client::connect::Connect>
where
...
impl<C: hyper::client::connect::Connect> AppsApiClient<C>
where
...
impl<C: hyper::client::connect::Connect> AppsApi for AppsApiClient<C>
where
    C: Clone + std::marker::Send + Sync,
{
    #[allow(unused_mut)]
