...
/// ConfigApplicationCommonLimits : Governs the life cycle of an application process.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationCommonLimits {
...
impl ConfigApplicationCommonLimits {
    /// Governs the life cycle of an application process.
    pub fn new() -> ConfigApplicationCommonLimits {
        ConfigApplicationCommonLimits {
            requests: None,
            timeout: None,
        }
    }
