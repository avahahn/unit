...
/// Status : Represents Unit's usage statistics.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct Status {
    #[serde(rename = "connections", skip_serializing_if = "Option::is_none")]
    pub connections: Option<Box<crate::models::StatusConnections>>,
    #[serde(rename = "requests", skip_serializing_if = "Option::is_none")]
    pub requests: Option<Box<crate::models::StatusRequests>>,
    /// Lists Unit's application process and request statistics.
    #[serde(rename = "applications", skip_serializing_if = "Option::is_none")]
    pub applications: Option<::std::collections::HashMap<String, crate::models::StatusApplicationsApp>>,
}

impl Status {
    /// Represents Unit's usage statistics.
    pub fn new() -> Status {
        Status {
            connections: None,
            requests: None,
