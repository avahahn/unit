...
/// ConfigListenerForwardedSource : Defines address-based patterns for trusted addresses.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigListenerForwardedSource {}

impl ConfigListenerForwardedSource {
    /// Defines address-based patterns for trusted addresses.
    pub fn new() -> ConfigListenerForwardedSource {
