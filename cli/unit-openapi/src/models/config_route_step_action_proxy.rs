...
/// ConfigRouteStepActionProxy : An object whose single option defines a step's proxy action.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigRouteStepActionProxy {
...
impl ConfigRouteStepActionProxy {
    /// An object whose single option defines a step's proxy action.
    pub fn new(proxy: String) -> ConfigRouteStepActionProxy {
