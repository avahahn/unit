...
/// CertBundleChainCertIssuer : An object that represents a certificate's issuer.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CertBundleChainCertIssuer {
...
impl CertBundleChainCertIssuer {
    /// An object that represents a certificate's issuer.
    pub fn new() -> CertBundleChainCertIssuer {
