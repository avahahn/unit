...
/// ConfigApplicationCommonIsolationUidmapInner : User ID mapping object.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationCommonIsolationUidmapInner {
    /// Starts the user ID mapping range in the app’s namespace.
    #[serde(rename = "container")]
    pub container: i32,
    /// Starts the user ID mapping range in the OS namespace.
    #[serde(rename = "host")]
    pub host: i32,
...
impl ConfigApplicationCommonIsolationUidmapInner {
    /// User ID mapping object.
    pub fn new(container: i32, host: i32, size: i32) -> ConfigApplicationCommonIsolationUidmapInner {
        ConfigApplicationCommonIsolationUidmapInner { container, host, size }
    }
}
