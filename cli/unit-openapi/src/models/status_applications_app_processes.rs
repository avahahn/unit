...
pub struct StatusApplicationsAppProcesses {
...
impl StatusApplicationsAppProcesses {
    /// Represents Unit's per-app process statistics.
    pub fn new() -> StatusApplicationsAppProcesses {
