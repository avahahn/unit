...
/// ConfigListener : An individual listener.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigListener {
    #[serde(rename = "tls", skip_serializing_if = "Option::is_none")]
    pub tls: Option<Box<crate::models::ConfigListenerTls>>,
    #[serde(rename = "forwarded", skip_serializing_if = "Option::is_none")]
    pub forwarded: Option<Box<crate::models::ConfigListenerForwarded>>,
