...
/// ConfigApplicationPython : Python application on Unit.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationPython {
...
impl ConfigApplicationPython {
    /// Python application on Unit.
    pub fn new(r#type: RHashType, module: String) -> ConfigApplicationPython {
