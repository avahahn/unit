...
/// StatusApplicationsApp : Represents Unit's per-app process and request statistics.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct StatusApplicationsApp {
    #[serde(rename = "processes", skip_serializing_if = "Option::is_none")]
    pub processes: Option<Box<crate::models::StatusApplicationsAppProcesses>>,
    #[serde(rename = "requests", skip_serializing_if = "Option::is_none")]
    pub requests: Option<Box<crate::models::StatusApplicationsAppRequests>>,
}

impl StatusApplicationsApp {
    /// Represents Unit's per-app process and request statistics.
    pub fn new() -> StatusApplicationsApp {
