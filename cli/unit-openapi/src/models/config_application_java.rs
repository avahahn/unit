...
/// ConfigApplicationJava : Java application on Unit.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationJava {
...
impl ConfigApplicationJava {
    /// Java application on Unit.
    pub fn new(r#type: RHashType, webapp: String) -> ConfigApplicationJava {
