...
/// ConfigApplicationCommon : Common application object options.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationCommon {
...
impl ConfigApplicationCommon {
    /// Common application object options.
    pub fn new(r#type: RHashType) -> ConfigApplicationCommon {
