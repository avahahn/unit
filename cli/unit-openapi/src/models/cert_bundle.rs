...
/// CertBundle : An object whose options represent a certificate bundle.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CertBundle {
    /// Certificate bundle's key type, i. e. RSA, ECDSA, etc.
    #[serde(rename = "key", skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    /// An array whose items represent certificates in a bundle.
    #[serde(rename = "chain", skip_serializing_if = "Option::is_none")]
    pub chain: Option<Vec<crate::models::CertBundleChainCert>>,
}

impl CertBundle {
    /// An object whose options represent a certificate bundle.
    pub fn new() -> CertBundle {
        CertBundle { key: None, chain: None }
    }
}
