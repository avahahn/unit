...
/// ConfigSettingsHttpStaticMimeType : An entity that defines an individual MIME type by listing file extensions.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigSettingsHttpStaticMimeType {}

impl ConfigSettingsHttpStaticMimeType {
    /// An entity that defines an individual MIME type by listing file extensions.
    pub fn new() -> ConfigSettingsHttpStaticMimeType {
