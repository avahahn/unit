...
/// ConfigApplicationCommonIsolationGidmapInner : Group ID mapping object.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationCommonIsolationGidmapInner {
    /// Starts the group ID mapping range in the app’s namespace.
    #[serde(rename = "container")]
    pub container: i32,
    /// Starts the group ID mapping range in the OS namespace.
    #[serde(rename = "host")]
    pub host: i32,
    /// Size of the ID range in both namespaces.
    #[serde(rename = "size")]
    pub size: i32,
}

impl ConfigApplicationCommonIsolationGidmapInner {
    /// Group ID mapping object.
    pub fn new(container: i32, host: i32, size: i32) -> ConfigApplicationCommonIsolationGidmapInner {
        ConfigApplicationCommonIsolationGidmapInner { container, host, size }
    }
}
