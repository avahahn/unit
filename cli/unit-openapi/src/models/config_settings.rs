...
/// ConfigSettings : An object whose single option represents global Unit settings.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigSettings {
    #[serde(rename = "http", skip_serializing_if = "Option::is_none")]
    pub http: Option<Box<crate::models::ConfigSettingsHttp>>,
}

impl ConfigSettings {
    /// An object whose single option represents global Unit settings.
    pub fn new() -> ConfigSettings {
        ConfigSettings { http: None }
    }
}
