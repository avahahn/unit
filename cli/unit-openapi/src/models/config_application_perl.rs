...
/// ConfigApplicationPerl : Perl application on Unit.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationPerl {
...
impl ConfigApplicationPerl {
    /// Perl application on Unit.
    pub fn new(r#type: RHashType, script: String) -> ConfigApplicationPerl {
