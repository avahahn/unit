...
/// ConfigRouteStep : An object whose options define a step's conditions and action.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigRouteStep {
    #[serde(rename = "action")]
    pub action: Box<crate::models::ConfigRouteStepAction>,
    #[serde(rename = "match", skip_serializing_if = "Option::is_none")]
    pub r#match: Option<Box<crate::models::ConfigRouteStepMatch>>,
}

impl ConfigRouteStep {
    /// An object whose options define a step's conditions and action.
    pub fn new(action: crate::models::ConfigRouteStepAction) -> ConfigRouteStep {
        ConfigRouteStep {
