...
/// ConfigRouteStepMatchArguments : Arguments supplied with the request’s query string.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigRouteStepMatchArguments {}

impl ConfigRouteStepMatchArguments {
    /// Arguments supplied with the request’s query string.
    pub fn new() -> ConfigRouteStepMatchArguments {
        ConfigRouteStepMatchArguments {}
    }
}
