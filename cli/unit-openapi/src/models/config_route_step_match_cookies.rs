...
/// ConfigRouteStepMatchCookies : Cookies supplied with the request.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigRouteStepMatchCookies {}

impl ConfigRouteStepMatchCookies {
    /// Cookies supplied with the request.
    pub fn new() -> ConfigRouteStepMatchCookies {
        ConfigRouteStepMatchCookies {}
    }
}
