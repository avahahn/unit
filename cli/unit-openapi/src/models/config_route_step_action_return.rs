...
/// ConfigRouteStepActionReturn : An object whose single option defines a step's return action.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigRouteStepActionReturn {
...
impl ConfigRouteStepActionReturn {
    /// An object whose single option defines a step's return action.
    pub fn new(r#return: i32) -> ConfigRouteStepActionReturn {
