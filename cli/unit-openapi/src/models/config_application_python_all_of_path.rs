...
/// ConfigApplicationPythonAllOfPath : Additional Python module lookup paths.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigApplicationPythonAllOfPath {}

impl ConfigApplicationPythonAllOfPath {
    /// Additional Python module lookup paths.
    pub fn new() -> ConfigApplicationPythonAllOfPath {
