...
pub struct StatusApplicationsAppRequests {
    /// Active app requests.
    #[serde(rename = "active", skip_serializing_if = "Option::is_none")]
    pub active: Option<i32>,
}

impl StatusApplicationsAppRequests {
    /// Represents Unit's per-app request statistics.
    pub fn new() -> StatusApplicationsAppRequests {
        StatusApplicationsAppRequests { active: None }
    }
}
