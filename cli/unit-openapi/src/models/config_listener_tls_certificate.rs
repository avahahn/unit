...
/// ConfigListenerTlsCertificate : Refers to one or more certificate bundles uploaded earlier.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConfigListenerTlsCertificate {}

impl ConfigListenerTlsCertificate {
    /// Refers to one or more certificate bundles uploaded earlier.
    pub fn new() -> ConfigListenerTlsCertificate {
